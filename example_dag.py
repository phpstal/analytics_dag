...
env_name = Variable.get("ENV_NAME", "stage")
CONFIG = {
    ...
    "public_ssh_key": Variable.get("YC_PUBLIC_SSH_KEY"),
    "log_group_id": "e23kqh78mqso6mqhr488" if env_name == "prod" else "e23l69csbv9pb5jt216i",
